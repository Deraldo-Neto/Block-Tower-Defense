...
public class SoundManager : Singleton<SoundManager> {
    ...
    void Start () {
        AudioClip[] clips = Resources.LoadAll<AudioClip>("Audio") as AudioClip[]; //carrega todas as musicas

        foreach (AudioClip clip in clips) //coloca todas as musicas em uma lista
        {
